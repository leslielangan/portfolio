    ...
    <div className="min-h-screen bg-white text-[#03110E]">
      ...
      <div className="max-w-[1200px] mx-auto px-20">
        ...
        <section className="py-[120px] pb-20 text-center" id="home">
          <h1 className="text-[84px] font-bold text-[#536B79] leading-tight mb-5" style={{ fontFamily: "'Allura', cursive" }}>
            Leslie Langan
          </h1>
      ...
      <div className="max-w-[1200px] mx-auto px-20">
        ...
        <section className="py-[140px]" id="agents">
          <div className="mb-20">
            <h2 className="text-[88px] font-black text-[#03110E] leading-[0.95] pb-6 border-b-[6px] border-[#26413C] inline-block" style={{ letterSpacing: '-3px' }}>
              AI-Powered <span className="text-[#536B79]" style={{ fontFamily: "'Allura', cursive", fontWeight: 700 }}>Agents</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-3 gap-9">
            ...
            >
              <div className="text-[96px] font-bold text-[#DBE6E5] leading-none mb-4" style={{ fontFamily: "'Allura', cursive" }}>01</div>
            ...
            >
              <div className="text-[96px] font-bold text-[#DBE6E5] leading-none mb-4" style={{ fontFamily: "'Allura', cursive" }}>02</div>
            ...
            >
              <div className="text-[96px] font-bold text-[#DBE6E5] leading-none mb-4" style={{ fontFamily: "'Allura', cursive" }}>03</div>
        ...
        <section className="py-[140px]" id="work">
          <div className="mb-20">
            <h2 className="text-[88px] font-black text-[#03110E] leading-[0.95] pb-6 border-b-[6px] border-[#26413C] inline-block" style={{ letterSpacing: '-3px' }}>
              Case Studies & <span className="text-[#536B79]" style={{ fontFamily: "'Allura', cursive", fontWeight: 700 }}>Work</span>
            </h2>
          </div>
      ...
      <section className="bg-[#DBE6E5] -mx-20 py-[140px]" id="about">
        <div className="grid grid-cols-2 gap-20 max-w-[1100px] mx-auto px-20">
          <div>
            <div className="text-[48px] font-bold text-[#536B79] mb-6 leading-tight" style={{ fontFamily: "'Allura', cursive" }}>
              Background
            </div>
